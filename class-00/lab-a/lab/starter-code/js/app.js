...
function displayPics(){
  while(viewed.length < 6){
    ...
    // console.log(rando);  ---IT'S WORK HERE BECOUSE IT'S INSIDE WHERE IT DECLEARED----
  }
  // console.log(rando);
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT :"It doesn't work because it is declared inside the while, and we consle it outside the while, but when i did the consle inside the while it was working"
  console.log(viewed);
